    ...
    >
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center flex flex-col items-center">
        ...
        >
          {/* Headline */}
          <h2
            className={`text-2xl sm:text-3xl lg:text-4xl font-sans font-bold tracking-tight leading-tight mb-3 ${
          ...
          <p
            className={`font-medium text-base sm:text-lg max-w-lg mx-auto mb-8 leading-relaxed ${
